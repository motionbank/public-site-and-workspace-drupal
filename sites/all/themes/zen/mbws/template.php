 ...
 *   entirety and paste it here, changing the prefix from theme_ to mbws_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: mbws_breadcrumb()
 *
 *   where mbws is the name of your sub-theme. For example, the
